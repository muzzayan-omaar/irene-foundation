...
// PAYMENT GATEWAY: frozen pending KYC/registration
// Swap this for a real gateway module once ready.
function initiatePayment(_params: {
  reference: string;
  amount: number;
  currency: string;
  callbackUrl: string;
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Find or create the donor by email
    ...
    // Create the donation as PENDING
