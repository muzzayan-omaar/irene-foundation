...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    donate_amountLabel: "Amount",
    donate_currencyLabel: "Currency",
    donate_currencyHint_usd: "Card payments — best for donors outside Uganda.",
    donate_currencyHint_ugx: "Mobile Money — best for donors in Uganda.",
    ...
    donate_agreeText: "I agree to the",
    donate_termsLink: "Terms of Service",
    donate_and: "and",
    donate_privacyLink: "Privacy Policy",
  ...
  fr: {
    ...
    donate_amountLabel: "Montant",
    donate_currencyLabel: "Devise",
    donate_currencyHint_usd: "Paiement par carte — idéal pour les donateurs hors d'Ouganda.",
    donate_currencyHint_ugx: "Mobile Money — idéal pour les donateurs en Ouganda.",
    ...
    donate_agreeText: "J'accepte les",
    donate_termsLink: "Conditions d'utilisation",
    donate_and: "et la",
    donate_privacyLink: "Politique de confidentialité",
